...
const Blog = () => {
    useTitle('Blog')
    return (
        <div className="max-w-7xl mx-auto font-bold py-6" data-aos="zoom-in">
            <h1
                className="text-4xl text-center pb-7">
                Blog Page
            </h1>

            <h2
                className="bg-warning p-5 rounded-xl text-2xl">
                1. What is an access token and refresh token? How do they work and where should we store them on the client-side?
            </h2>
            <p
                className="text-1xl p-5 text-zinc-700 font-extrabold">
