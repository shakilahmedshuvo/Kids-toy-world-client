...
const CustomerToys = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            <h2
                className="text-center font-bold text-5xl mt-16 mb-5">
            ...
            <div className="grid lg:grid-cols-2 mt-10 sm:">
                <div
                    data-aos="fade-right">
                    <img
                        src="https://img.freepik.com/free-photo/vintage-miniature-car-fake-landscape_155003-1097.jpg?w=740&t=st=1684433870~exp=1684434470~hmac=eb56748cdca34bf292340beab67377992d9e608f4f2f28ca746f9fa45b584d68"
                        alt="" />
                </div>
                    ...
                    <div
                        ...
                        <div className="font-bold">
                            <p
                                className="mb-6">
                                $9.99 <span
                                    className="line-through ms-2 text-slate-400">
                                    $19.99
                                </span>
                            </p>
